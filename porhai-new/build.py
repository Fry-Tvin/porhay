...
# исходном положении. Раньше сюда по ошибке переиспользовались данные
# варианта А (тот же mx/ro «на глаз неотличимо») — это было неверно вдвойне:
# и механизм другой (paint() крутит бесконечно вместо разового качка), и
# сами цифры чужие. Пересняты напрямую из spec (animation.scroll.keyframes
# у rec572370702, page34664661.json) — там честные 3 кейфрейма
# (di 0 → 200 → 210, т.е. пик почти в конце и мгновенный сеттл), плюс
# у каждой чёрточки оказался свой сдвиг по Y (my), которого не было в
# прежней модели вообще — раньше все 16 сидели на одной высоте.
# (x %, y px, ширина px, ключ файла, базовый поворот °, mx px, my px, доворот ro °)
CONFETTI_FLIP = [
    (0.00, 38, 17, 'fe3676d5', 135, 22, -21, -50), (2.92, 52, 17, '4bfa8c73', -90, 41, 9, -90),
    (15.65, 22, 17, 'ce4b55ff', 90, -37, 16, 70), (18.26, 56, 17, '8c2a0952', -135, 52, 2, -100),
    (25.93, 60, 17, '9cae1dcb', -135, 54, -7, -100), (34.15, 34, 17, 'd4abbe9e', 135, 35, -17, -35),
    (38.74, 50, 17, '24e3675d', -90, 51, 1, -85), (45.85, 27, 17, 'ceeef3f3', -135, 50, -22, -75),
    (51.94, 57, 17, '9cae1dcb', -135, 54, -7, -85), (57.87, 24, 17, 'd4abbe9e', 180, 46, 5, -65),
    (64.58, 45, 17, '24e3675d', -90, 51, 3, -90), (70.04, 14, 17, 'ceeef3f3', -90, 43, 10, -90),
    (76.60, 27, 17, 'ba8b36e1', -90, 36, 24, -55), (89.09, 45, 17, '13fdaa4f', 81, -60, 11, 95),
    (90.83, 22, 17, 'a5847e0b', -90, 24, 17, -35), (99.76, 49, 17, 'c5a30fb3', -102, 27, 10, -55),
]
